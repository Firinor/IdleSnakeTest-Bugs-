...
namespace Managers
{
    public class MainShopManager : Singleton<MainShopManager>
    {
        ...
        public void UpgradeGreatEyes()
        {
            ...
            int newCost = (int)(_startCost * Mathf.Pow(_multiplyCost, UpgradesManager.GreatEyes));
            _costs[0].text = newCost.ToString();
        ...
        public void UpgradeFoodFinding()
        {
            ...
            int newCost = (int)(_startCost * Mathf.Pow(_multiplyCost, UpgradesManager.FoodFinding));
            _costs[1].text = newCost.ToString();
        ...
        public void UpgradeSteelStomach()
        {
            ...
            int newCost = (int)(_startCost * Mathf.Pow(_multiplyCost, UpgradesManager.SteelStomach));
            _costs[2].text = newCost.ToString();
        ...
        public void UpgradeAdrenalineGlands()
        {
            ...
            UIManager.Instance.UpdateCoinValue();
            _currentValue[3].text = $"{100 + 10 * (adrenalineGlands+1)}%";
            int newCost = (int)(_startCost * Mathf.Pow(_multiplyCost, BoostManager.AdrenalineGlands));
            _costs[3].text = newCost.ToString();
        ...
        public void UpgradePathfinding()
        {
            ...
            int newCost = (int)(_startCost * Mathf.Pow(_multiplyCost, UpgradesManager.Pathfinding));
            _costs[4].text = newCost.ToString();
        ...
        public void UpgradeStrongMuscles()
        {
            ...
            _currentValue[5].text = $"{1 + 0.1 * (strongMuscles)}";
            int newCost = (int)(_startCost * Mathf.Pow(_multiplyCost, UpgradesManager.StrongMuscles));
            _costs[5].text = newCost.ToString();
        ...
        public void UpgradeFastMetabolism()
        {
            ...
            _currentValue[6].text = $"{300 + 10 * (fastMetabolism)}%";
            int newCost = (int)(_startCost * Mathf.Pow(_multiplyCost, BoostManager.FastMetabolism));
            _costs[6].text = newCost.ToString();
